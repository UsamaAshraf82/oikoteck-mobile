  ...
  return (
    <View style={styles.container}>
      {SubmitOfferVisible && (
        <SubmitOffer
          property={property}
          onClose={() => setSubmitOfferVisible(false)}
          visible={SubmitOfferVisible}
        />
      )}
      {contactOwnerVisible && (
        <ContactOwner
        ...
        <View style={styles.content}>
          ...
          <View style={styles.infoWrapper}>
              ...
              <>
                ...
                <View style={styles.addressCard}>
                  ...
                  <View style={styles.cardInfoRow}>
                    ...
                    <AppText style={styles.cardInfoText}>
                      {property.address}
                    </AppText>
                  </View>
                </View>
            ...
            <View style={styles.sectionHeader}>
              ...
              <AppText style={styles.bulletItem}>
                ...
                {property.move_in_date instanceof Date
                  ? DateTime.fromJSDate(property.move_in_date).toLocaleString(
                      DateTime.DATE_SHORT,
                      {
                        locale: 'en-GB',
                      }
                  ...
                  : DateTime.fromISO(
                      (property.move_in_date as any).iso
            ...
            <View style={styles.sectionHeader}>
              ...
              <AppText style={styles.bulletItem}>
                • {property.deposit}-
                {property.deposit === 1 ? 'Month' : 'Months'} Security Deposit
              </AppText>
            </View>
            <View style={styles.spacer48} />
            <View style={styles.sectionHeader}>
              <AppText style={styles.sectionTitleNeighbor}>
