      ...
      {localValue && (
        ...
        >
          ...
          <View style={styles.labelWrapper}>
            <AppText style={styles.labelText}>{localValue.label}</AppText>
            {localValue.hasXIcon && (
            ...
            >
              <FlashList
                ...
                renderItem={({ item }: { item: any }) => {
                  const isEqual = isDeepEqual(item.value, localValue.value);
                  return (
                    <TouchableNativeFeedback
                      onPress={() => localValue.onPress?.(item)}
                    >
