...
type AreaOption = { area_1: string; area_2: string };

type Props = {
  visible: boolean;
  onClose: () => void;
  onPress: (data: AreaOption) => void;
  value?: string;
  district?: string;
};

const Area = ({ visible, onClose, district, value = '', onPress }: Props) => {
    ...
    <Modal
      ...
      <View
        ...
        <FlashList
          ...
          renderItem={({ item }: { item: AreaOption }) => {
