...
export async function logInsightRecorded(insightType: string, propertyId: string) {
  await analytics().logEvent('insight_recorded', {
    insight_type: insightType,
    property_id: propertyId,
  });
}

export async function logConversionEvent(insightType: string, propertyId: string) {
  await analytics().logEvent('conversion_event', {
    insight_type: insightType,
    property_id: propertyId,
    value: 1.0,
    currency: 'EUR',
